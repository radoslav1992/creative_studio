...
import { Check, Zap, Crown, Star, Pencil, Users } from 'lucide-react';
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1 mt-3">
                    {model.capabilities.map((cap) => (
                      ...
                      >
                        {cap === 'text-to-video' && 'Текст → Видео'}
                        {cap === 'image-to-video' && 'Изображение → Видео'}
                        {cap === 'text-to-image' && 'Текст → Изображение'}
                        {cap === 'image-editing' && 'Редактиране'}
                        {cap === 'character-consistency' && 'Персонаж'}
                      </span>
                    ))}
                  </div>
                </button>
